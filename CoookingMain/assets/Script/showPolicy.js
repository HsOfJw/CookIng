cc.Class({
    ...
    onLoad () {
        ...
        bg.getComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame(this.com.res_loaded["png_xinzhengce_bg"]);
    ...
    btnClose: function(event, coustEvent) {
        ...
        this.node.dispatchEvent(new cc.Event.EventCustom("closeMonthTargetInfo", true));
