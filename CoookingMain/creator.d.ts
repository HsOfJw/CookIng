...
declare module cc {	
	...
	*/
	...
	/**
	returns a random float between 0 and 1, use cc.random0To1 directly 
	*/
	...
	*/
	...
	console.log(cc.isValid(node));    // true
	node.destroy();
	console.log(cc.isValid(node));    // true, still valid in this frame
	// after a frame...
	console.log(cc.isValid(node));    // false, destroyed in the end of last frame
	``` 
	*/
	...
	*/
	...
	@example 
	```js
	console.log(cc.colorEqual(cc.Color.RED, new cc.Color(255, 0, 0))); // true
	``` 
	*/
	...
	*/
	...
	export class Game extends EventTarget {		
		...
		1. debugMode<br/>
		     ...
		     1 - cc.error, cc.assert, cc.warn, console.log will print in console.                      <br/>
		     2 - cc.error, cc.assert, cc.warn will print in console.                              <br/>
		     3 - cc.error, cc.assert will print in console.                                       <br/>
		     4 - cc.error, cc.assert, cc.warn, console.log will print on canvas, available only on web.<br/>
		...
		1. debugMode（debug 模式，但是在浏览器中这个选项会被忽略）                                <br/>
		     "debugMode" 各种设置选项的意义。                                                   <br/>
		         0 - 没有消息被打印出来。                                                       <br/>
		         1 - cc.error，cc.assert，cc.warn，console.log 将打印在 console 中。                  <br/>
		         2 - cc.error，cc.assert，cc.warn 将打印在 console 中。                          <br/>
		         3 - cc.error，cc.assert 将打印在 console 中。                                   <br/>
		         4 - cc.error，cc.assert，cc.warn，console.log 将打印在 canvas 中（仅适用于 web 端）。 <br/>
	...
	export class Node extends _BaseNode {		
		...
		*/
		...
		console.log("Running Action Count: " + count);
		``` 
		*/
		...
		@example 
		```js
		console.log("Node Position: " + node.getPosition());
		``` 
		*/
		getPosition(): Vec2;		
		/**
		...
		*/
		...
		@example 
		```js
		console.log("Node Scale: " + node.getScale());
		``` 
		*/
		getScale(): number;		
		/**
		...
		*/
		...
		@example 
		```js
		console.log("Content Size: " + node.getContentSize());
		``` 
		*/
		...
		*/
		...
		@example 
		```js
		console.log("Node AnchorPoint: " + node.getAnchorPoint());
		``` 
		*/
		getAnchorPoint(): Vec2;		
		/**
		...
		*/
		...
		@example 
		```js
		console.log("AnchorPointInPoints: " + node.getAnchorPointInPoints());
		``` 
		*/
		...
		*/
		...
		@example 
		```js
		console.log(node.isCascadeOpacityEnabled());
		``` 
		*/
	...
	export class TiledLayer extends _SGComponent {		
		...
		*/
		...
		console.log("MapTile size: " + mapTileSize);
		``` 
		*/
		getMapTileSize(): Size;		
		/**
		...
		*/
		...
		console.log("Layer Orientation: " + orientation);
		``` 
		*/
	...
	export class Layout extends Component {		
		...
		console.log(childNode.x); // not yet changed
		layout.updateLayout();
		console.log(childNode.x); // changed
		``` 
		*/
		updateLayout(): void;		
	...
	export class Widget extends Component {		
		...
		console.log(widget.node.y); // not yet changed
		widget.updateAlignment();
		console.log(widget.node.y); // changed
		``` 
		*/
	...
	export class loader extends Pipeline {		
		...
		*/
		...
		cc.loader.load('a.png', function (err, tex) {
		    console.log('Result should be a texture: ' + (tex instanceof cc.Texture2D));
		});
		...
		*/
		...
		cc.loader.loadRes('misc/character/cocos', function (err, prefab) {
		    ...
		    console.log('Result should be a prefab: ' + (prefab instanceof cc.Prefab));
		});
		...
		*/
		...
		loadingItems.onComplete = function (errors, items) {
		     if (error)
		         ...
		         console.log('Completed ' + items.totalCount + ' items');
		 }
		``` 
		*/
		...
		cc.LoadingItems.create(cc.loader, ['a.png', 'b.plist'], function (completedCount, totalCount, item) {
		     ...
		     if (errors) {
		         for (var i = 0; i < errors.length; ++i) {
		             console.log('Error url: ' + errors[i] + ', error: ' + items.getError(errors[i]));
		         }
		     }
		     else {
	...
	export class Color extends ValueType {		
		...
		*/
		...
		color2 = cc.Color.RED;
		console.log(color2.equals(color1)); // false;
		``` 
		*/
...
declare module sp {	
	...
	export class Skeleton extends cc._RendererUnderSG {		
		...
		console.log(bone.worldX); // return 0;
		spine.updateWorldTransform();
		bone = spine.findBone('head');
		console.log(bone.worldX); // return -23.12;
		``` 
		*/
